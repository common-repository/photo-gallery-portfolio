...
class AdamLabsGallery_Export {
	
	public function export_grids($export_grids){
		$export_grids = apply_filters('adamlabsgallery_export_grids_pre', $export_grids);
		...
		return apply_filters('adamlabsgallery_export_grids_post', $return_grids);
	}
	
	
	public function export_skins($export_skins){
		$export_skins = apply_filters('adamlabsgallery_export_skins_pre', $export_skins);
		...
		return apply_filters('adamlabsgallery_export_skins_post', $return_skins);
	}
	
	
	public function export_elements($export_elements){
		$export_elements = apply_filters('adamlabsgallery_export_elements_pre', $export_elements);
		...
		return apply_filters('adamlabsgallery_export_elements_post', $return_elements);
	}
	
	
	public function export_navigation_skins($export_navigation_skins){
		$export_navigation_skins = apply_filters('adamlabsgallery_export_navigation_skins_pre', $export_navigation_skins);
		
		$return_nav_skins = array();
		if($export_navigation_skins !== false && !empty($export_navigation_skins)){
			$c_skins = new AdamLabsGallery_Navigation();
			$skins = $c_skins->get_adamlabsgallery_navigation_skins();
		...
		return apply_filters('adamlabsgallery_export_navigation_skins_post', $return_nav_skins);
	}
	
	
	public function export_custom_meta($export_custom_meta){
		$export_custom_meta = apply_filters('adamlabsgallery_export_custom_meta_pre', $export_custom_meta);
		...
		return apply_filters('adamlabsgallery_export_custom_meta_prost', $return_metas);
	}
	
	
	public function export_adamlabs_fonts($export_adamlabs_fonts){
		$export_adamlabs_fonts = apply_filters('adamlabsgallery_export_adamlabs_fonts_pre', $export_adamlabs_fonts);
		
		$return_metas = array();
		if($export_adamlabs_fonts !== false && !empty($export_adamlabs_fonts)){
			$fonts = new AdamLabs_Fonts();
			$custom_fonts = $fonts->get_all_fonts();
			
			if(!empty($export_adamlabs_fonts)){
				foreach($custom_fonts as $c_font){
					foreach($export_adamlabs_fonts as $font){
		...
		return apply_filters('adamlabsgallery_export_adamlabs_fonts_post', $return_metas);
	}
	
	
	public function export_global_styles($export_global_styles){
		$export_global_styles = apply_filters('adamlabsgallery_export_global_styles_pre', $export_global_styles);
		...
		return apply_filters('adamlabsgallery_export_global_styles_post', $global_styles);
	}
